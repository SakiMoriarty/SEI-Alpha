...
const EMAIL_SETTINGS = [
  'addresses' => ['jamesmoriarty8@yahoo.com'], // кому необходимо отправить письмо
  'from' => ['AnimeSEI@domain.com', 'AnimeSEI'], // от какого email и имени необходимо отправить письмо
